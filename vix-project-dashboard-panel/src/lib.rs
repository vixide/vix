//! Live project metrics for the dashboard overlay (Tools → Project Dashboard).
//!
...
/// Project metrics shown in the dashboard. Each `Option` is `None` while its
...
pub struct Dashboard {
    ...
    /// Number of files under the project root.
