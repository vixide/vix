...
impl Panel {
    ...
    pub fn down(&mut self) {
        self.selected = vix_list_state::down(self.selected, LEN);
    }
    ...
    pub fn page_down(&mut self, page: usize) {
        self.selected = vix_list_state::page_down(self.selected, page, LEN);
    }
    ...
    pub fn select_index(&mut self, idx: usize) -> bool {
        match vix_list_state::select_index(idx, LEN) {
            Some(i) => {
                self.selected = i;
                true
            }
    ...
    pub fn ensure_visible(&mut self, height: usize) {
        self.scroll = vix_list_state::ensure_visible(self.selected, self.scroll, height, LEN);
    }
