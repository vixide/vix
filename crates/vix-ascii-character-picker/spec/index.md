...
See the per-crate spec: `crates/vix-nerd-font-picker/spec/index.md`.
...
See the per-crate spec: `crates/vix-ascii-character-picker/spec/index.md`.
...
See the per-crate spec: `crates/vix-html-character-picker/spec/index.md`.
...
See the per-crate spec: `crates/vix-x11-color-picker/spec/index.md`.
...
- The Tools menu entries live in `crates/vix-menu/src/lib.rs` (`menu.item.tools.nerd_palette`,
