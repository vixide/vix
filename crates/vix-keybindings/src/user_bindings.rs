...
//! ```
//!
//! T104h scope only: the file format and load/save round trip. Checking a
//! loaded override against a live `KeyEvent`, conflict detection against
//! other overrides, and reporting a shadowed built-in are T104i's job —
//! see `spec/index.md`'s "Override layer" section (`Override`/`Source`,
//! not built yet) — this module doesn't reference [`crate::lookup`] at
//! all.
