...
mod export;
pub use export::{to_html, to_ics, to_latex, to_markdown};
...
mod tests {
    ...
    fn html_export_neutralizes_dangerous_link_schemes() {
        ...
        assert_eq!(export::safe_href("https://x.test"), "https://x.test");
        assert_eq!(export::safe_href("javascript:alert(1)"), "#");
    }
