...
const EDIT_MACRO: &[Item] = &[
    Item::leaf("menu.item.edit.record_macro", "macro.record", ""),
    Item::leaf("menu.item.edit.play_macro", "macro.play", ""),
...
const VIEW_EDITOR: &[Item] = &[
    ...
    Item::leaf("menu.item.view.highlight_word", "view.highlight_word", ""),
...
const TOOLS: &[Item] = &[
    ...
    Item::leaf("menu.item.tools.http_send", "tools.http_send", ""),
