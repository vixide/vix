...
//! cancelling a hung query), and [`ai_features`] (Ask/fix-error/explain/
//! optimize — `pub`, unlike its two siblings, since [`ai_features::
//! AiRequest`] crosses the crate boundary to the host).
