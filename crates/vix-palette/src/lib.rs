...
pub const COMMANDS: &[(&str, &str)] = &[
    ...
    ("cmd.column_select_down", "edit.column_select_down"),
    ("cmd.column_select_up", "edit.column_select_up"),
    ...
    ("cmd.structural_replace", "edit.structural_replace"),
    (
        "cmd.structural_replace_workspace",
    ...
    ("cmd.lsp_implementation", "nav.goto_implementation"),
    ...
    ("cmd.lsp_linked_edit", "lsp.linked_edit"),
    ("cmd.lsp_code_action", "lsp.code_action"),
    ("cmd.lsp_code_lens", "lsp.code_lens"),
    ...
    ("cmd.bookmark_toggle", "bookmark.toggle"),
    ("cmd.bookmark_next", "bookmark.next"),
    ("cmd.bookmark_prev", "bookmark.prev"),
    ("cmd.bookmark_list", "bookmark.list"),
    ...
    ("cmd.record_macro", "macro.record"),
    ("cmd.play_macro", "macro.play"),
    ...
    ("cmd.git_pull_ff", "git.pull_ff"),
    ("cmd.git_pull_rebase", "git.pull_rebase"),
    ("cmd.git_pull_merge", "git.pull_merge"),
    ...
    ("cmd.db_connections", "db.connections"),
    ("cmd.db_query", "db.query"),
    ("cmd.db_history", "db.history"),
    ("cmd.db_saved", "db.saved"),
