...
- menu "Tools"
  - submenu "Generate"
    - submenu "UUID"
      - menuitem "1 = Time + MAC" -> Generate UUID v1 using a timestamp, a monotonic counter, and a MAC address.
      ...
      - menuitem "6 = Time + MAC" -> Generate UUID v6 using a timestamp such that the IDs are physically sortable.
