...
From the **Edit** menu or the command palette. Pure logic in `crate::textops::transpose_chars_at` / `transpose_words_at`; host method `App::transpose` via `App::rewrite_at_cursor`.
