# vix-workspace-dashboard-panel

Workspace dashboard panel displays helpful information about the current workspace, its files, its specifications, its history, etc.

**Status:** Shipped (first cut) — **Tools → Workspace Dashboard** opens a read-only
...
The crate (`vix-workspace-dashboard-panel`) holds the metric state; the host
