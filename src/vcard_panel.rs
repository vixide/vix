...
//!
//! [`Panel::open`] takes a parsed [`Vcard`](crate::vcard_parser::Vcard) and turns
...
mod tests {
    ...
    fn builds_labelled_rows() {
        let v = crate::vcard_parser::parse(
    ...
    fn navigation_clamps() {
        let v = crate::vcard_parser::parse("FN:A\nEMAIL:a@b.c\nTEL:123\n");
